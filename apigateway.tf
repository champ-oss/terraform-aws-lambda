locals {
  api_gateway_v1_resource_id   = var.enable_api_gateway_v1 && var.create_api_gateway_v1_resource && var.enabled ? aws_api_gateway_resource.this[0].id : var.api_gateway_v1_resource_id
  api_gateway_v1_resource_path = var.enable_api_gateway_v1 && var.create_api_gateway_v1_resource && var.enabled ? aws_api_gateway_resource.this[0].path : var.api_gateway_v1_resource_path
}
