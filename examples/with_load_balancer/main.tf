...
module "vpc" {
  source                   = "git::git@github.com:champ-oss/terraform-aws-vpc.git?ref=v1.0.1-afc8890"
  git                      = local.git
...
module "acm" {
  source            = "git::git@github.com:champ-oss/terraform-aws-acm.git?ref=v1.0.1-1cb7679"
  git               = local.git
...
module "alb" {
  source          = "git::git@github.com:champ-oss/terraform-aws-alb.git?ref=dfa6af4a7490ad56c85548e2364be4ea3e72b3d4"
  git             = local.git
